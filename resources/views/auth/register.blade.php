...
@section('content')
    <div class="text-center py-4 lg:px-4">
        <div class="p-2 bg-indigo-800 items-center text-indigo-100 leading-none rounded-full flex inline-flex" role="alert">
            <span class="flex rounded-full bg-indigo-500 px-2 py-1 text-xs font-bold mr-3">Hey!</span>
            <span class="font-semibold mr-2 text-left flex-auto">Registration is not required to order coffee. Just enter your name, and pay!</span>
        </div>
    </div>
